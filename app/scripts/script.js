...
function generateProgress(val) {
    ...
    return `
        <div class="progress" style="height: 25px;">
            <div class="progress-bar ${colorClass}" role="progressbar" style="width: ${val}%" aria-valuenow="${val}" aria-valuemin="0" aria-valuemax="100">${val}%</div>
        </div>
    `;
}
...
function logArrayElements(element, index, array) {
    ...
    switch (element.status) {
        case 2:
            status = '<span class="badge badge-pill pull-right badge-success">online</span>'
            break;
        case 8:
            status = '<span class="badge badge-pill pull-right badge-warning">seems offline</span>'
            break;
        case 9:
            status = '<span class="badge badge-pill pull-right badge-danger">offline</span>'
            break;
        case 1:
            status = '<span class="badge badge-pill pull-right badge-secondary">not yet checked</span>';
            break;
    }
